...
def load() -> HLConfig:
    ...
    return HLConfig(
        ...
        quick_model=os.getenv("CUSTOM_LLM_MODEL",
                              os.getenv("TRADINGAGENTS_QUICK_THINK_LLM", "Combo-1")),
        deep_model=os.getenv("CUSTOM_LLM_MODEL",
                             os.getenv("TRADINGAGENTS_DEEP_THINK_LLM", "Combo-1")),
